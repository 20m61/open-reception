...
## オープン issue 一覧（9 件・2026-07-03 更新）

> 2026-07-02 の自律ループで #264/#275/#273/#261/#83/#289 をクローズ（PR #276〜#293）。
> ローカルで消化可能なタスクは #274/#284 の残増分のみ。次の関門は **#195 の実 AWS apply（要ユーザー承認）**。
...
| **#274** | refactor | inc1 #291 + **②device/kiosk 統合 #294 済**。残: 移行順①③〜⑦（visitstay/platform/directory/reception/log/機会的廃止） | 進行中 |
