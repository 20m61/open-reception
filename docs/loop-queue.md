...
**次に着手する候補（2026-07-31 更新・第 96 wave 消化後）**

> **VRT まわりは片付いた。** 第 95・96 wave で許容値 0.02 が隠していた退行 3 件をすべて
> 取り除き、ベースラインは darwin 12 / linux 12 で均衡した。次は本来の機能開発へ戻る。
>
> 0. **#421 admin IA 再編**（重複ナビの統合＝概念一本化は要ユーザー確認なので除く）。
