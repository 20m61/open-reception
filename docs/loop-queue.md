...
**第 15 wave（次に着手する）**: signage nested-interactive 修正(#361)／ #363 Inc4 相当の残があれば
issue-ac-mapping で確定／ 新規候補は issue 一覧の再棚卸しから／ **ユーザー判断待ち(deploy のみ)**:
#405 Inc2 の Secrets Manager 有効化 deploy・#366 Stack の deploy(月 $14.2 見積の最終承認)・
#4 実資格情報(#65)
