...
**第 8 wave（次に着手する）**: #405 Inc1（テナント別プロバイダ設定: ドメイン+`TenantSecretStore` mock+developer CRUD。**セキュリティ AC blocking**）／ voice の `onResolved`→TargetView 実結線+demo-studio synthetic 組込(#364/#363)／ #363 Inc3 公開モデル／ #361 残(VRT/axe)／
