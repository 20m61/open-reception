...
const ACTION_LABEL: Partial<Record<AuditAction, string>> = {
  ...
  'reception.demo_scenario_saved': '受付体験スタジオ: シナリオ保存',
  'reception.demo_scenario_deleted': '受付体験スタジオ: シナリオ削除',
  'reception.demo_publication_created': '受付体験スタジオ: 公開単位作成',
  'reception.demo_publication_deleted': '受付体験スタジオ: 公開単位削除',
  'reception.demo_status_changed': '受付体験スタジオ: 状態変更',
  'reception.demo_published': '受付体験スタジオ: 公開',
  'reception.demo_rolled_back': '受付体験スタジオ: ロールバック',
  ...
  'routing_policy.created': '取次ルート: 作成',
  'routing_policy.updated': '取次ルート: 更新',
  'routing_policy.deleted': '取次ルート: 削除',
